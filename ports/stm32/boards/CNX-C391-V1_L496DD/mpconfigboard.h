#define MICROPY_HW_BOARD_NAME       "CNX-C391-V1_L496DC"
...
// Define file system storage.
#define MICROPY_HW_HAS_FLASH        (1)
#define MICROPY_HW_ENABLE_INTERNAL_FLASH_STORAGE (0)
#define MICROPY_HW_SPIFLASH_SIZE_BITS (64 * 1024 * 1024) // 8 MiB
#define MICROPY_HW_SPIFLASH_USE_QSPI (0)
#define MICROPY_HW_SPIFLASH_USE_SPI (0)
#define MICROPY_HW_SPIFLASH_USE_SOFT_SPI (1)

// External SPI Flash config
#if !MICROPY_HW_ENABLE_INTERNAL_FLASH_STORAGE && \
    defined(MICROPY_HW_SPIFLASH_SIZE_BITS) && MICROPY_HW_SPIFLASH_SIZE_BITS > 0

#if MICROPY_HW_SPIFLASH_USE_QSPI // use QSPI flash for storage.

#elif MICROPY_HW_SPIFLASH_USE_SPI // use SPI flash for storage.
#define MICROPY_HW_SPI_IS_RESERVED(id)  (id == 1)// Reserve SPI flash bus.

#else // use softSPI flash for storage.
#define MICROPY_HW_SPIFLASH_CS      (pyb_pin_FLASH_CS) // Pins defined in pins.csv
...
// #define MICROPY_BOARD_EARLY_INIT    board_early_init // Set nHOLD and nWP.
