#define MICROPY_HW_BOARD_NAME       "CNX-C371-V11_L496AB with UART5"
...
#define MICROPY_HW_UART5_NAME   "U-5"
#define MICROPY_HW_UART5_TX     (pin_C12)  // B14
#define MICROPY_HW_UART5_RX     (pin_D2)  // B15
