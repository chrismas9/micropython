#define MICROPY_HW_BOARD_NAME       "CNX-C362-V10_L476-R161"
...
// USART & UART config
#define MICROPY_HW_UART1_NAME   "U-H5"
#define MICROPY_HW_UART1_TX     (pin_B6) // H5
#define MICROPY_HW_UART1_RX     (pin_B7) // H6
...
// Connexi has 2 LEDs. PH0/BLUE not available on L476
