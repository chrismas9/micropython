#define MICROPY_HW_BOARD_NAME       "CNX-C371-V10_F405BEXT10"
...
#define MICROPY_HW_CLK_USE_BYPASS   (1) // HSE comes from oscillator module.
...
#define MICROPY_HW_SPI1_MISO (pin_B4) // H9
#define MICROPY_HW_SPI1_MOSI (pin_B5) // H10

#define MICROPY_HW_SPI2_NAME "S-H14"
//#define MICROPY_HW_SPI2_NSS  (pin_C8) // H13 MASTER ONLY
#define MICROPY_HW_SPI2_SCK  (pin_B13) // H14
#define MICROPY_HW_SPI2_MISO (pin_C2) // H15
#define MICROPY_HW_SPI2_MOSI (pin_C3) // H16
